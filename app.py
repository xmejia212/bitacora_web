...
with tab_registro:
    ...
    if operacion == "Nueva Anotación":
        ...
        if df_db.empty:
            ...
            # Diseñamos la cuadrícula interactiva fila por fila usando columnas de Streamlit
            ...
            for idx, fila in df_ultimos.iterrows():
                ...
                # Botón de lápiz/editar para cada fila con una clave única
                ...
                # Cortar texto largo de observación para que no rompa el diseño visual de la lista
